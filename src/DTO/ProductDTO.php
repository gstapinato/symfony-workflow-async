...
class ProductDTO
{
    public function __construct(
        ...
        #[GreaterThanOrEqual(value:0, message: "Retail price should be greater than zero")]
        public ?float $retailPrice = null,
        #[GreaterThanOrEqual(value:0, message: "Discounted price should be greater than zero")]
